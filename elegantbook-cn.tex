    ...
    \item   设向量 $\boldsymbol{\alpha}=\left(\begin{array}{l}1 \\ 2\end{array}\right), \boldsymbol{\beta}=\left(\begin{array}{l}2 \\ 1\end{array}\right)$. 
            ...
            \begin{tikzpicture}[scale=1, transform shape]
              ...
              \begin{scope}[shift={(0,0)}]
                % Draw axes
                \draw[thick,->] (-2,0) -- (4,0) node[anchor=north west] {$x$};
              ...
              \begin{scope}[shift={(7,0)}]
                ...
                \draw[thick,->,blue,dashed] (0,0) -- (1,-2) node[anchor=east] {$\text{Reflect}_{x}(\boldsymbol{\alpha})$};
  ...
  \item 设向量 $\boldsymbol{u}=\left(\begin{array}{l}1 \\ 2\end{array}\right)$ ，
        ...
        \begin{figure}[!h]
          ...
          \begin{tikzpicture}[scale=1, transform shape]
            ...
            % Original vector v
            \draw[thick,->,blue] (0,0) -- (2,1) node[above] {$\boldsymbol{v}$};
            
            % Scaled vector 2v
            \draw[thick,->,red] (0,0) -- (4,2) node[above] {$2\boldsymbol{v}$};
          
            % Transformed vector T(v)
            \draw[thick,->,green] (0,0) -- (6,2) node[above] {$T(\boldsymbol{v})$};
          
            % Transformed vector T(2v)
            \draw[thick,->,orange] (0,0) -- (12,4) node[above] {$T(2\boldsymbol{v})$};
